  ...
  function updateConfig() {
    ...
    var cfg = {
      ...
      params: {
        ...
        azure_model: pluginApi.pluginSettings?.azureModel || "mai-transcribe-1.5",
        azure_speech_endpoint: pluginApi.pluginSettings?.azureSpeechEndpoint || "",
        azure_speech_key: pluginApi.pluginSettings?.azureSpeechKey || "",
        azure_openai_endpoint: pluginApi.pluginSettings?.azureOpenaiEndpoint || "",
        azure_openai_key: pluginApi.pluginSettings?.azureOpenaiKey || "",
        azure_openai_deployment: pluginApi.pluginSettings?.azureOpenaiDeployment || "",
